		...
		<div class="banner-intro">
			<div class="wrap">
				<div class="title variant36">
                    <div class="<?=$arResult['H1COLOR']?>"><?=$arResult['NAME']?></div>
				</div>
			</div>
		</div>
	</section>
    ...
    <section class="article">
		<div class="wrap flex bgwhite rounded">
            ...
            <aside class="flex column">
                <div class="breadcrumbs"><a href="/directions/">Все направления</a></div>
                <div class="leftnav">
            ...
            <article>
                <div class="name">Наши решения</div>
                <h1><?=$arResult['LONGNAME']?></h1>
